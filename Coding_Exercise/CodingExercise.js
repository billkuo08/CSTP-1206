...
console.log(`The sum of the array is ${getSum(MyArr)}`);//55
...
console.log(hasYandy("Crazy"));//Yes
console.log(hasYandy("York"));//Yes
console.log(hasYandy("hello"));//Error
console.log(hasYandy(0));//Error
...
console.log(`The factorial of the given number is ${findFactorial(5)}`);//120
...
console.log(`The grade of the student is ${reportCard(40, 40, 40, 40)}`);//F
console.log(`The grade of the student is ${reportCard(70, 70, 70, 70)}`);//B
console.log(`The grade of the student is ${reportCard(90, 90, 90, 90)}`);//A
console.log(`The grade of the student is ${reportCard(50, 50, 50, 50)}`);//C
